...
#Entry : { lineno: U64, val: I64 }

#toEntries : List I64 -> List Entry
#toEntries = \list ->
#    List.mapWithIndex list (\val, lineno -> { lineno, val })


#sortEntries : Entry, Entry -> [LT, EQ, GT]
#sortEntries = \{ lineno: _, val: x }, { lineno: _, val: y } ->
#    Num.compare x y
